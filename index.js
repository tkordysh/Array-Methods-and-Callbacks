...
function getFinals(data) {
    const finalistsArray = data.filter(item => item.Stage === 'Final');
    return finalistsArray;
}
...
function getWinners(array, getFinalsCB) {
    const winners = getFinalsCB(array).map(item => item['Home Team Goals'] > item[ 'Away Team Goals']
...
function getWinnersByYear(array, getFinalsCB, getYearsCB, getWinnersCB) {
    ...
    const winnersByYearArray = winners.map((item, index) => `In ${years[index]}, ${item} won the world cup!`)
    return winnersByYearArray;
}
